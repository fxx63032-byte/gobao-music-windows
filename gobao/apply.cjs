...
patch('public/js/modules/07-fx/04-preset-grid-uniforms.js', 'gobao-clear-background-on-manual-preset', 'function setPreset(p, opts) {\n  opts = opts || {};', 'function setPreset(p, opts) {\n  // gobao-clear-background-on-manual-preset: 普通视觉预设接管画面时关闭 GO宝视频层。\n  var gobaoManualPresetSelection = opts == null;\n  opts = opts || {};\n  if (gobaoManualPresetSelection && typeof gobaoClearBackgroundForManualPreset === \'function\') gobaoClearBackgroundForManualPreset();');
